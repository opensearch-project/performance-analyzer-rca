...
public @interface AErrorPatternIgnored {
     ...
     *
     * @return Patterns that will be considered before the error log. If multiple patterns are
     *     specified, then the presence of any of the them will ignore the log line.
     */
    String pattern();
