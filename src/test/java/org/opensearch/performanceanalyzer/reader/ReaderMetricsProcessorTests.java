...
//     * writes 1 to the right window at 7000l + reader reads at 11001l + writer writes 3 to the
// right
//     * window at 12000l + reader reads at 16001l
//     *
//     * <p>Given metrics in two writer windows calculates a new reader window which overlaps with
// the
...
//     * modification time. leftWindow = metricsMap.get(7000) = 1 rightWindow =
// metricsMap.get(12000)
//     * = 3
//     *
...
//     * 17001] and the window [12001 ~ 17001] does not exist, reader would skip aligning and use
// the
...
//
//    /**
//     * Make sure we return null in alignNodeMetrics when right window {} snapshot ends at or
// before
//     * endTime. This is possible because writer writes in less than 5 seconds (writer does not
//     * guarantee write every 5 seconds). Reader does not expect that. Changed to return null in
// this
//     * case.
//     *
//     * @throws Exception if something went wrong.
