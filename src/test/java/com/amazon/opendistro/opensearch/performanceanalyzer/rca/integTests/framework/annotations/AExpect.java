...
/**
 * This annotation is used for validating the result. After invoking the test, the RcaItRunner
 * periodically checks the output and passes the test if it passes the validator checks.
 */
...
public @interface AExpect {
    ...
    /**
     * Currently supported places to look for RCA outputs are the SQLite file or by hitting the rest
     * endpoint.
     */
    enum Type {
        REST_API,
