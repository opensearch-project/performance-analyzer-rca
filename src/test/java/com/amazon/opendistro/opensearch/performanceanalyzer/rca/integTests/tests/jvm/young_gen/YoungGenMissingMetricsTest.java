...
package com.amazon.opendistro.opensearch.performanceanalyzer.rca.integTests.tests.jvm.young_gen;
            ...
            tables = {
                @ATable(
                        ...
                        tuple = {
                            @ATuple(
                                    dimensionValues = {
                                        AllMetrics.GCType.Constants.TOT_FULL_GC_VALUE
                                    },
                                    sum = 5000,
                                    avg = 5000,
                                    min = 5000,
                            ...
                            @ATuple(
                                    dimensionValues = {
                                        AllMetrics.GCType.Constants.TOT_YOUNG_GC_VALUE
                                    },
                                    sum = 500,
                                    avg = 500,
                                    min = 500,
