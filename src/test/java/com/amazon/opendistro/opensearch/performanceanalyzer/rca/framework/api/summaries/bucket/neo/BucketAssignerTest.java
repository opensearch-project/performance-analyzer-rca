...
package com.amazon.opendistro.opensearch.performanceanalyzer.rca.framework.api.summaries.bucket.neo;
...
public class BucketAssignerTest {
    ...
    public void testCreateBucketAssigner() throws JsonProcessingException {
        ...
        Assert.assertEquals(
                UsageBucket.HEALTHY_WITH_BUFFER, bucketCalculatorForBase3.compute(40.1));
