...
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.persistence.pck1.TestPersist;
...
public class SqliteObjectPersistorTest {
    ...
    /**
     * This test checks that we get a null Object in case the Database is created but it does not
     * contain table with the object data we are asking for.
     */
    @Test
    ...
    public void persistTwoClassesWithSameName() throws Exception {
        ...
        com.amazon.opendistro.opensearch.performanceanalyzer.rca.persistence.pck2.TestPersist
                testPersist2 =
                        new com.amazon.opendistro.opensearch.performanceanalyzer.rca.persistence
                                .pck2.TestPersist();
    ...
    public void testGetterReturnMismatch()
        ...
        exceptionRule.expectMessage(
                "The return type of the getter 'getX' (class java.lang.Integer) and field 'x' (int) don't match.");
        class TypeMismatch {
            @ValueColumn int x;
    ...
    public void testCollectionOfPrimitives()
        ...
        class CollectionOfPrimitives {
            @ValueColumn List<Integer> ll = new ArrayList<>();
