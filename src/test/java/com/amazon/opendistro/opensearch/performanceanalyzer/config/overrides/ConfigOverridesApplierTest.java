...
public class ConfigOverridesApplierTest {
    ...
    @Mock private RcaController mockRcaController;

    @Mock private RcaConf mockRcaConf;

    @Captor ArgumentCaptor<Set<String>> newMutedRcas;

    @Captor ArgumentCaptor<Set<String>> newMutedDeciders;

    @Captor ArgumentCaptor<Set<String>> newMutedActions;
    ...
    public void testApplyValidOverrides() throws JsonProcessingException {
        ...
        testOverridesApplier.applyOverride(
                overridesJson, Long.toString(lastAppliedTimestamp + 300));

        verify(mockRcaConf)
                .updateAllRcaConfFiles(
                        newMutedRcas.capture(),
                        newMutedDeciders.capture(),
    ...
    private ConfigOverrides buildTestOverrides() {
        ...
        ConfigOverrides.Overrides enabled = new ConfigOverrides.Overrides();
