...
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.exceptions.MalformedAnalysisGraph;
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.framework.api.Metric;
import java.util.LinkedList;
import java.util.List;
import java.util.Queue;

public abstract class NonLeafNode<T extends GenericFlowUnit> extends Node<T>
