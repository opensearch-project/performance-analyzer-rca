...
public class SQLParsingUtil {
    ...
    /**
     * retrieve the record from result list if the data stored in one particular field of that
     * record matches the name string.
     *
     ...
     */
    private static Record getRecordByName(Result<Record> result, Field<String> field, String name)
    ...
    /**
     * Read data from the SQL result queried from metricDB metric table will look something similar
     * to : [[MemType, sum, avg, min, max], [Eden, 8.6555376E7, 8.6555376E7, 8.6555376E7,
     * 8.6555376E7], [Heap, 5.4237588E8, 5.4237588E8, 5.4237588E8, 5.4237588E8], For example :
     * matchedField => "MemType", matchedFieldName => "Heap", dataField => "Max" and we will read
     * 5.4237588E8 from the result
     *
     * @param result the record result from SQL query
     ...
     */
    public static double readDataFromSqlResult(
            Result<Record> result,
            Field<String> matchedField,
        ...
        try {
            ...
            LOG.error(
                    "{} fails to match any row in field {}.",
                    matchedFieldName,
                    matchedField.getName());
