...
public abstract class SuppressibleAction implements Action {
    ...
    /**
     * Returns true if the configured action is actionable, false otherwise. The method is also
     * declared final to enforce checking for muted-ness of an action before declaring it
     * actionable.
     *
     ...
     *
     * <p>Examples of invalid actions are resource configurations where limits have been reached.
     *
