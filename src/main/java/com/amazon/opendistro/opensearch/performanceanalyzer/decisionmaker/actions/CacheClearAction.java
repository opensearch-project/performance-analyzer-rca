...
public class CacheClearAction extends SuppressibleAction {
    ...
    public CacheClearAction(
        ...
        this.impactedNodes =
                appContext.getDataNodeInstances().stream()
    ...
    public String summary() {
        Summary summary = new Summary(impactedNodes, coolOffPeriodInMillis, canUpdate);
    ...
    public static class Summary {
        ...
        public Summary(
                final List<NodeKey> impactedNodes, long coolOffPeriodInMillis, boolean canUpdate) {
