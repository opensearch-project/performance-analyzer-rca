...
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.exceptions.OverridesAndPrecedenceOrderCountMismatch;
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.exceptions.OverridesAndPrecedenceOrderValueMismatch;
...
class Threshold {
    ...
    /**
     * Run through the overrides in the order of the precedence-list and return the first match or
     * the default otherwise.
     *
     * @return value of the threshold.
     */
    public String get(RcaConf rcaConf) {
        // In the order as defined in the precedence order, we go through the overrides map, and
        // this
        // gives us all
        ...
        for (String overrideCategory : overridePrecedenceOrder) {
            ...
            // Get the overrideCategory's value from the RcaConf's tags. With that value, we check
            // if
            // there is an
            // override available. If so, we return, otherwise, we inspect the next override
            // category.
