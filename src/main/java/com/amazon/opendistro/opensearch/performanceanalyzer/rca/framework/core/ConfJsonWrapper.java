...
class ConfJsonWrapper {
    ...
    ConfJsonWrapper(
        ...
        this.mutedRcaList =
                mutedRcas == null ? ImmutableList.of() : ImmutableList.copyOf(mutedRcas);
        this.mutedDeciderList =
                mutedDeciders == null ? ImmutableList.of() : ImmutableList.copyOf(mutedDeciders);
        this.mutedActionList =
                mutedActions == null ? ImmutableList.of() : ImmutableList.copyOf(mutedActions);
