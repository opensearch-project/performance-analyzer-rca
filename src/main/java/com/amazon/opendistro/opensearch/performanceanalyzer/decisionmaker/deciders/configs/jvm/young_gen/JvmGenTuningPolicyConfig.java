...
package com.amazon.opendistro.opensearch.performanceanalyzer.decisionmaker.deciders.configs.jvm.young_gen;


import com.amazon.opendistro.opensearch.performanceanalyzer.decisionmaker.deciders.jvm.JvmGenTuningPolicy;
...
/**
 * Configures various options for the {@link JvmGenTuningPolicy}
 *
 * <p>The config follows the format below "decider-config-settings": {
 * "jvm-gen-tuning-policy-config": { "enabled": true, "allow-young-gen-downsize": false,
 * "day-breach-threshold": 5, "week-breach-threshold": 7, "day-monitor-window-size-minutes": 1440
 * "week-monitor-window-size-minutes": 5760 "day-monitor-bucket-size-minutes": 30
...
public class JvmGenTuningPolicyConfig {
    ...
    private static final String WEEK_MONITOR_WINDOW_SIZE_MINUTES =
            "week-monitor-window-size-minutes";
    private static final String DAY_MONITOR_BUCKET_SIZE_MINUTES = "day-monitor-bucket-size-minutes";
    private static final String WEEK_MONITOR_BUCKET_SIZE_MINUTES =
            "week-monitor-bucket-size-minutes";
    ...
    public static final int DEFAULT_DAY_MONITOR_WINDOW_SIZE_MINUTES =
            (int) TimeUnit.DAYS.toMinutes(1);
    public static final int DEFAULT_WEEK_MONITOR_WINDOW_SIZE_MINUTES =
            (int) TimeUnit.DAYS.toMinutes(4);
    public static final int DEFAULT_DAY_MONITOR_BUCKET_SIZE_MINUTES = 30;
    public static final int DEFAULT_WEEK_MONITOR_BUCKET_SIZE_MINUTES =
            (int) TimeUnit.DAYS.toMinutes(1);
    ...
    public JvmGenTuningPolicyConfig(NestedConfig config) {
        ...
        allowYoungGenDownsize =
                new Config<>(
                        ALLOW_YOUNG_GEN_DOWNSIZE,
                        config.getValue(),
                        DEFAULT_ALLOW_YOUNG_GEN_DOWNSIZE,
                        Boolean.class);
        dayBreachThreshold =
                new Config<>(
                        DAY_BREACH_THRESHOLD,
                        config.getValue(),
                        DEFAULT_DAY_BREACH_THRESHOLD,
                        Integer.class);
        weekBreachThreshold =
                new Config<>(
                        WEEK_BREACH_THRESHOLD,
                        config.getValue(),
                        DEFAULT_WEEK_BREACH_THRESHOLD,
                        Integer.class);
        dayMonitorWindowSizeMinutes =
                new Config<>(
                        DAY_MONITOR_WINDOW_SIZE_MINUTES,
                        config.getValue(),
                        DEFAULT_DAY_MONITOR_WINDOW_SIZE_MINUTES,
                        Integer.class);
        weekMonitorWindowSizeMinutes =
                new Config<>(
                        WEEK_MONITOR_WINDOW_SIZE_MINUTES,
                        config.getValue(),
                        DEFAULT_WEEK_MONITOR_WINDOW_SIZE_MINUTES,
                        Integer.class);
        dayMonitorBucketSizeMinutes =
                new Config<>(
                        DAY_MONITOR_BUCKET_SIZE_MINUTES,
                        config.getValue(),
                        DEFAULT_DAY_MONITOR_BUCKET_SIZE_MINUTES,
                        Integer.class);
        weekMonitorBucketSizeMinutes =
                new Config<>(
                        WEEK_MONITOR_BUCKET_SIZE_MINUTES,
                        config.getValue(),
                        DEFAULT_WEEK_MONITOR_BUCKET_SIZE_MINUTES,
                        Integer.class);
    }
