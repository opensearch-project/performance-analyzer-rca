...
package com.amazon.opendistro.opensearch.performanceanalyzer.rca.store.rca.temperature;
...
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.framework.core.temperature.TemperatureVector;
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.store.metric.temperature.TemperatureMetricsBase;
...
import com.amazon.opendistro.opensearch.performanceanalyzer.rca.store.metric.temperature.byShard.calculators.ShardBasedTemperatureCalculator;
...
public class DimensionalTemperatureCalculator {
     ...
     *
     * <p>The Node temperature as the actual value. (If normalized to 10 this will always be 10 as
     * this is the base for the normalization).
     *
     ...
     *     be accounted for at a shard level. For example, HttpServer consuming CPU will form part
     *     of this. Currently this is not used in the calculation for the mean node temperature.
     *     This will be needed whenever we will auto-suggest the movement of shards across nodes.
