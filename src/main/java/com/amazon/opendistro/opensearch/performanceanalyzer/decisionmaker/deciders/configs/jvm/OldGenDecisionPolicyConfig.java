...
package com.amazon.opendistro.opensearch.performanceanalyzer.decisionmaker.deciders.configs.jvm;
...
/**
 * "decider-config-settings": { "old-gen-decision-policy-config": { "queue-bucket-size": 10,
 * "old-gen-threshold-level-one": 0.6, "old-gen-threshold-level-two": 0.75,
 * "old-gen-threshold-level-three": 0.9, "level-one-config": { ...... }, "level-two-config": {
 * ...... } } }
 */
public class OldGenDecisionPolicyConfig {
    ...
    private static final String OLD_GEN_THRESHOLD_LEVEL_ONE_CONFIG_NAME =
            "old-gen-threshold-level-one";
    private static final String OLD_GEN_THRESHOLD_LEVEL_TWO_CONFIG_NAME =
            "old-gen-threshold-level-two";
    private static final String OLD_GEN_THRESHOLD_LEVEL_THREE_CONFIG_NAME =
            "old-gen-threshold-level-three";
    ...
    public OldGenDecisionPolicyConfig(NestedConfig oldGenConfig) {
        levelOneActionBuilderConfig =
                new LevelOneActionBuilderConfig(
                        new NestedConfig(LEVEL_ONE_CONFIG_NAME, oldGenConfig.getValue()));
        levelTwoActionBuilderConfig =
                new LevelTwoActionBuilderConfig(
                        new NestedConfig(LEVEL_TWO_CONFIG_NAME, oldGenConfig.getValue()));
        levelThreeActionBuilderConfig =
                new LevelThreeActionBuilderConfig(
                        new NestedConfig(LEVEL_THREE_CONFIG_NAME, oldGenConfig.getValue()));
        oldGenThresholdLevelOne =
                new Config<>(
                        OLD_GEN_THRESHOLD_LEVEL_ONE_CONFIG_NAME,
                        oldGenConfig.getValue(),
                        DEFAULT_OLD_GEN_THRESHOLD_LEVEL_ONE,
                        (s) -> (s > 0),
                        Double.class);
        oldGenThresholdLevelTwo =
                new Config<>(
                        OLD_GEN_THRESHOLD_LEVEL_TWO_CONFIG_NAME,
                        oldGenConfig.getValue(),
                        DEFAULT_OLD_GEN_THRESHOLD_LEVEL_TWO,
                        (s) -> (s > oldGenThresholdLevelOne.getValue()),
                        Double.class);
        oldGenThresholdLevelThree =
                new Config<>(
                        OLD_GEN_THRESHOLD_LEVEL_THREE_CONFIG_NAME,
                        oldGenConfig.getValue(),
                        DEFAULT_OLD_GEN_THRESHOLD_LEVEL_THREE,
                        (s) -> (s > oldGenThresholdLevelTwo.getValue()),
                        Double.class);
        queueBucketSize =
                new Config<>(
                        QUEUE_BUCKET_SIZE_CONFIG_NAME,
                        oldGenConfig.getValue(),
                        DEFAULT_QUEUE_BUCKET_SIZE,
                        (s) -> (s > 0),
                        Integer.class);
    }
