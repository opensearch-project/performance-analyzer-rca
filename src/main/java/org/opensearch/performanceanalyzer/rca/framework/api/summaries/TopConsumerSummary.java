...
public class TopConsumerSummary extends GenericSummary {
    ...
    public static final String TOP_CONSUMER_SUMMARY_TABLE =
            TopConsumerSummary.class.getSimpleName();
    ...
    public TopConsumerSummaryMessage buildSummaryMessage() {
        final TopConsumerSummaryMessage.Builder summaryMessageBuilder =
                TopConsumerSummaryMessage.newBuilder();
    ...
    /**
     * TopConsumerSummary is the lowest level summary in the nest summary hierarchy. So it doesn't
     * carry any nested summary list and thus we override this with an empty method.
     */
    @Override
    public void buildSummaryMessageAndAddToFlowUnit(FlowUnitMessage.Builder messageBuilder) {}

    public static TopConsumerSummary buildTopConsumerSummaryFromMessage(
            TopConsumerSummaryMessage message) {
    ...
    public static TopConsumerSummary buildSummary(Record record) {
        ...
        try {
            String name =
                    record.get(
                            TopConsumerSummaryField.CONSUMER_NAME_FIELD.getField(), String.class);
            Double value =
                    record.get(
                            TopConsumerSummaryField.CONSUMER_VALUE_FIELD.getField(), Double.class);
